...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("cover_image", sa.VARCHAR, server_default="", nullable=True),
...
def downgrade() -> None:
    op.drop_index("pub_idx_url", table_name="publishers")
    op.drop_index("pub_idx_url_hash", table_name="publishers")
